...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Flip A Boat Wiki',
    description: 'Copyright and intellectual property information for Flip A Boat Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Flip A Boat Wiki',
      description: 'Copyright and intellectual property information for Flip A Boat Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2026 Flip A Boat Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Flip A Boat Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Flip A Boat Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Roblox</strong> - Owner of the Roblox platform</li>
              <li><strong>Flip A Boat Developers</strong> - Creators of the Flip A Boat game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Flip A Boat</strong> - Trademark of the game developers</li>
              <li><strong>Flip A Boat Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Flip A Boat Wiki.
            </p>
            ...
            <p>
              ...
              Flip A Boat Wiki<br />
              Email: <a href="mailto:dmca@flip-a-boat.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@flip-a-boat.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Flip A Boat Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Flip A Boat Wiki (flip-a-boat.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@flip-a-boat.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@flip-a-boat.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@flip-a-boat.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@flip-a-boat.wiki</a>
            </p>
            <p>
